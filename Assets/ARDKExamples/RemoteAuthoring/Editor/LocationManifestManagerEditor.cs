...
namespace Niantic.ARDKExamples.RemoteAuthoring.Editor
{
    ...
    public class LocationManifestManagerEditor : UnityEditor.Editor
    {
        ...
        private void DropAreaGUI ()
        {
            ...
            Rect droppingArea = new Rect(0.0f, 30.0f, EditorGUIUtility.currentViewWidth, 25f);
                ...
                case EventType.DragPerform:
                    ...
                    if (evt.type == EventType.DragPerform) {
                        ...
                        if(DragAndDrop.objectReferences != null) {
                            var manifestJson = locationManifestManager.ManifestJson;
                            var manifests = locationManifestManager.Manifests;
                            var textAsset = new TextAsset(manifestJson);
                            var objList = new Object[1] {textAsset};
                            // locationManifestManager.Manifests = AddContentAsManifests(objList, manifests);
